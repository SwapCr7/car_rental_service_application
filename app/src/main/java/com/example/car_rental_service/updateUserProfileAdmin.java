...
public class updateUserProfileAdmin extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update_user_profile_admin);
    ...
    public void editUserProfileAdmin(View view) {
        ...
        SharedPreferences sharedpreferences = getSharedPreferences(MainActivity.MyPREFERENCES, Context.MODE_PRIVATE);
        Map sessionMap = sharedpreferences.getAll();
        db.updateProfile(getIntent().getStringExtra("username"), firstNameText, lastNameText,password,emailText,phoneText, addressText, cityText, stateText, zipcodeText, uta_id, arlingtonClub);

        Toast.makeText(getApplicationContext(), "Modification Successfull!!!", Toast.LENGTH_SHORT).show();
        TextView username = findViewById(R.id.usernameText);
        Intent intent = new Intent(updateUserProfileAdmin.this, UserDetails.class);
