...
public class UserDetails extends AppCompatActivity {
    ...
    public void updateUserProfile(View view) {
        ...
        Intent intent = new Intent(UserDetails.this, updateUserProfileAdmin.class);
        intent.putExtra("username", username.getText().toString());
        startActivityForResult(intent, 0);
    }
    public void editUserRole(View view){
        EditText username = findViewById(R.id.usernameText);
        Intent intent = new Intent(UserDetails.this, editUserRole.class);
        intent.putExtra("username", username.getText().toString());
        startActivityForResult(intent, 0);
    }
    public void revokerenter(View view) {
        EditText username = findViewById(R.id.usernameText);
        Intent intent = new Intent(UserDetails.this, revokeRenter.class);
        intent.putExtra("username", username.getText().toString());
        startActivityForResult(intent, 0);
    }
